...
export function IconButton({ icon, label, variant = 'view', ...props }: IconButtonNavLinkProps) {
    const baseClasses =
        'bg-transparent! inline-flex items-center justify-center rounded-md p-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-1 hover:cursor-pointer'
